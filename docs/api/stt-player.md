...
| `getQoeStats()`                      | Session QoE counters (stalls, startup, creep, seeks + settle p50, gate entries by reason, frontier snap-backs, permanent blocks) — see [QoE counters](./playback-governor.md#qoe-counters).                                                          |
