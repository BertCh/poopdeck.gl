...
| `wireframe`                          | `boolean`                          | `false`                   | Draw the column edges as a wireframe — `ColumnLayer` pass-through.                                                                                                                                                                                     |
| `filled`                             | `boolean`                          | `true`                    | Fill the column disks/extrusions — `ColumnLayer` pass-through.                                                                                                                                                                                         |
| `stroked`                            | `boolean`                          | `false`                   | Draw an outline stroke on each column's disk — `ColumnLayer` pass-through. Gates the `lineColor` / `lineWidth` / `lineWidth*` props below.                                                                                                             |
| `flatShading`                        | `boolean`                          | `false`                   | Flat rather than smooth shading on the extrusion — `ColumnLayer` pass-through.                                                                                                                                                                         |
