 ...
 *
 * See `stt:docs/roadmap/neural-atlas-2026-07.md` §14.
 */
      ...
      <div style={shellStyle}>
        <div style={{ maxWidth: 560, padding: 28, color: '#e6ebf5' }}>
          ...
          <p style={{ color: '#98a4bd' }}>
            ...
            <code>stt:scripts/data-generation/neural_atlas.py</code> and served
            from <code>examples/showcase/public/data</code> under{' '}
